            ...
            {ROWS.map(({ feature, velodoc, competitor }, i) => (
              ...
              >
                ...
                <td className="py-4 px-5 text-center">
                  {velodoc ? (
                    <span
                      className="inline-flex items-center justify-center w-8 h-8 rounded-full bg-teal-accent/20 text-teal-accent"
                      aria-label="Yes"
                    >
                    ...
                    <span
                      className="inline-flex items-center justify-center w-8 h-8 rounded-full bg-white/10 text-slate-500"
                      aria-label="No"
                    >
                ...
                <td className="py-4 px-5 text-center">
                  {competitor ? (
                    <span
                      className="inline-flex items-center justify-center w-8 h-8 rounded-full bg-red-500/20 text-red-400"
                      aria-label="Typical of Traditional OCR"
                    >
                      <X className="w-5 h-5" />
                    </span>
                  ) : (
                    <span className="text-slate-500 font-mono text-sm" aria-hidden>
                      —
                    </span>
                  )}
                </td>
